...
export default function TaskForm({ onSubmit }) {
    ...
    return (
        <form onSubmit={handleSubmit} className='new-item-form flex flex-col w-5/6 text-gray-100 border-solid border-8 border-white rounded-b-none bg-gray-700 p-2 '>
